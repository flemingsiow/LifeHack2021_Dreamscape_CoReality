...
var admin = ['flemingsiow@gmail.com'];
...
for (i = 1; i < 4; i ++) {
	...
	if (!existing) {
		options = {
			...
			last_name: last,
			email: 'instructor' + last + "@gmail.com",
...
// add test users to ST1501
var course = Courses.findOne({code:'ST1501'})
if (course) {
...
SeoCollection.update(
	{
		...
		$set: {
			...
			og: {
				'title': 'Virtual Classroom',
				'description': 'Utilize affordable 360 cameras and VR headset like Google Cardboard to create a virtual environment',
				'url': 'https://flemingsiow.com',
				'image': 'https://flemingsiow.com/icons/cardboard.png'
			}
		}
	}, {
		upsert:true
